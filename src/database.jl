...
"""
    bulkdocs(db::Database; data=[], options=Dict())
...
"""
    updatedoc(db::Database; id::AbstractString=nothing, rev::AbstractString=nothing, body=Dict())
...
"""
    deletedoc(db::Database; id::AbstractString=nothing, rev::AbstractString=nothing)
